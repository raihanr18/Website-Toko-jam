...
<body>
    <div class="wrapper">
        ...
        <nav id="sidebar">
            <div class="sidebar-header">
                <h3>Kurang Lebih</h3>
                <img src="../img/putih.png" width="30" height="30">
            </div>
            ...
            <ul class="list-unstyled CTAs">
                <li>
                    <a href="../auth/logout.php" class="article" onclick="return confirm('Apakah anda yakin untuk log out ?')">Log out</a>
                </li>
            </ul>
            <?php 
                ...
                <ul class='list-unstyled CTAs'>
                        <li>
                            <a href='../admin/main_admin.php' class = 'btn btn-light' >Kembali ke halaman admin</a>
                        </li>
                </ul>
                    ";
                }
    ...
    <div class="produk">
        <?php while ($result = mysqli_fetch_assoc ($query)) :?>
                    ...
                    <div class="overlay">
                        <div class="text"><a href="src/preview.php?id=<?php echo $result['id_produk']; ?>">Quick preview</a></div>
                    </div>
