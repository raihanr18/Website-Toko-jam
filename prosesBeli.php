...
<center>
    ...
    $getData  = mysqli_query($koneksi, "SELECT harga FROM paket_wisata WHERE id_wisata ='$value'");
    ...
    if(isset($_POST['bayar'])){
      ...
      $code = mysqli_query($koneksi, "INSERT INTO pembelian VALUES('', '$user', '$produk', '$hasil')");
      if($code == TRUE){
