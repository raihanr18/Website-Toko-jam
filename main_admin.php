      ...
      <table class="table table-hover table-dark">
        ...
        <?php while ($result = mysqli_fetch_assoc ($query)):?>
          <tr>
            ...
            <td>
              <a href="form_ubah_paket.php?id=<?php echo $result['id_produk']; ?>" class="btn btn-secondary"> Edit</a>
              <a href="proses_hapus_paket.php?id=<?php echo $result['id_produk']; ?>" class="btn btn-danger" onclick="return confirm('untuk menghapus data ini?')"> Hapus</a>
            </td>
          </tr>
        </tbody>
      <?php endwhile; ?>
